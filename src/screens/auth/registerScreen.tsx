...
const RegisterScreen: React.FC<Props> = ({ onRegister, onLogin }) => {
        ...
        >
            ...
            <View style={styles.header}>
                <Image
                    ...
                    resizeMode="contain"
                />
                <UvTypography variant="h3" align="center">REGISTER</UvTypography>
                <View style={{ height: 8 }} />
            ...
            <View style={styles.form}>
                <View style={styles.formContent}>
                    <UvTypography variant="h6" color={Colors.white} style={{ marginBottom: 8 }}>NAME</UvTypography>
                    <UvFormTextInput
                ...
                <View style={styles.footerRow}>
                    <UvTypography variant="body" color="#CFE2EA">Already have an account?</UvTypography>
