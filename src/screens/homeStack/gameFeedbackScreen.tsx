...
const RightArrowIcon = ({ width = 16, height = 16, color = Colors.black }: { width?: number; height?: number; color?: string }) => (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.bottomButtonContainer}>
        <UvButton
          ...
          icon={<RightArrowIcon width={16} height={16} color={Colors.base[950]} />}
          iconPosition="right"
